...
public class SettingsController {
    ...
    @GetMapping("/{name}")
    public SettingsDTO getSettings(@PathVariable String name) {
    ...
    @PostMapping
    public ResponseEntity<Long> setSettings(@RequestBody SettingsDTO settings) {
    ...
    @PutMapping("/{name}")
    public ResponseEntity<Void> updateSettings(@PathVariable String name, @RequestBody SettingsDTO settings) {
    ...
    @DeleteMapping("/{name}")
    public ResponseEntity<Void> deleteSettings(@PathVariable String name) {
